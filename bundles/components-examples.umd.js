(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('tslib'), require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@angular/router'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@gsa-sam/components-examples', ['exports', 'tslib', '@angular/core', '@angular/common', '@angular/forms', '@angular/router', 'rxjs'], factory) :
    (global = global || self, factory((global.gsaSam = global.gsaSam || {}, global.gsaSam.componentsExamples = {}), global.tslib, global.ng.core, global.ng.common, global.ng.forms, global.ng.router, global.rxjs));
}(this, (function (exports, tslib, i0, i1, forms, i2, rxjs) { 'use strict';
