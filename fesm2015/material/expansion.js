...
/** @nocollapse */ ExpansionExpandCollapseAllExample.ɵcmp = ɵɵdefineComponent({ type: ExpansionExpandCollapseAllExample, selectors: [["expansion-toggle-all-example"]], viewQuery: function ExpansionExpandCollapseAllExample_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵɵlistener("focus", function ExpansionExpandCollapseAllExample_Template_input_focus_37_listener($event) { ɵɵrestoreView(_r470); const _r469 = ɵɵreference(39); return _r469.open(); });
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        const _r469 = ɵɵreference(39);
        ɵɵadvance(37);
        ɵɵproperty("matDatepicker", _r469);
...
/** @nocollapse */ ExpansionStepsExample.ɵcmp = ɵɵdefineComponent({ type: ExpansionStepsExample, selectors: [["expansion-steps-example"]], decls: 48, vars: 4, consts: [[1, "example-headers-align"], ["hideToggle", "", 3, "expanded", "opened"], ["matInput", "", "placeholder", "First name"], ["matInput", "", "type", "number", "min", "1", "placeholder", "Age"], ["mat-button", "", "color", "primary", 3, "click"], ["matInput", "", "placeholder", "Country"], ["mat-button", "", "color", "warn", 3, "click"], ["matInput", "", "placeholder", "Date", "readonly", "", 3, "matDatepicker", "focus"], ["picker", ""]], template: function ExpansionStepsExample_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵɵlistener("focus", function ExpansionStepsExample_Template_input_focus_40_listener($event) { ɵɵrestoreView(_r472); const _r471 = ɵɵreference(42); return _r471.open(); });
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        ɵɵadvance(9);
        ɵɵproperty("matDatepicker", _r471);
