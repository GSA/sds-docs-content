...
function ProgressSpinnerConfigurableExample_section_22_Template(rf, ctx) { if (rf & 1) {
    const _r644 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "section", 1);
    ɵɵelementStart(1, "label", 2);
    ɵɵtext(2, "Progress:");
    ɵɵelementEnd();
    ɵɵelementStart(3, "mat-slider", 11);
    ɵɵlistener("ngModelChange", function ProgressSpinnerConfigurableExample_section_22_Template_mat_slider_ngModelChange_3_listener($event) { ɵɵrestoreView(_r644); const ctx_r643 = ɵɵnextContext(); return ctx_r643.value = $event; });
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r642 = ɵɵnextContext();
    ɵɵadvance(3);
    ɵɵproperty("ngModel", ctx_r642.value);
} }
/**
