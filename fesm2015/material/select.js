...
function SelectCustomTriggerExample_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(1);
    ɵɵtextInterpolate2(" (+", ctx_r366.toppings.value.length - 1, " ", (ctx_r366.toppings.value == null ? null : ctx_r366.toppings.value.length) === 2 ? "other" : "others", ") ");
} }
function SelectCustomTriggerExample_mat_option_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("value", topping_r368);
    ɵɵadvance(1);
    ɵɵtextInterpolate(topping_r368);
} }
/**
...
function SelectFormExample_mat_option_7_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("value", food_r375.value);
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", food_r375.viewValue, " ");
} }
function SelectFormExample_option_17_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("value", car_r376.value);
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", car_r376.viewValue, " ");
} }
/**
 * @record
 */
...
function SelectHintErrorExample_mat_option_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("value", animal_r380);
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", animal_r380.name, " ");
} }
...
function SelectMultipleExample_mat_option_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("value", topping_r382);
    ɵɵadvance(1);
    ɵɵtextInterpolate(topping_r382);
} }
/**
...
function SelectOptgroupExample_mat_optgroup_8_mat_option_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("value", pokemon_r386.value);
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", pokemon_r386.viewValue, " ");
} }
function SelectOptgroupExample_mat_optgroup_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("label", group_r384.name)("disabled", group_r384.disabled);
    ɵɵadvance(1);
    ɵɵproperty("ngForOf", group_r384.pokemon);
} }
/**
 * @record
 */
...
function SelectOverviewExample_mat_option_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("value", food_r388.value);
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", food_r388.viewValue, " ");
} }
/**
 * @record
 */
...
function SelectResetExample_mat_option_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("value", state_r390);
    ɵɵadvance(1);
    ɵɵtextInterpolate(state_r390);
} }
/**
