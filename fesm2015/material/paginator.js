...
function PaginatorConfigurableExample_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(4);
    ɵɵtextInterpolate1("List length: ", ctx_r277.pageEvent.length, "");
    ɵɵadvance(2);
    ɵɵtextInterpolate1("Page size: ", ctx_r277.pageEvent.pageSize, "");
    ɵɵadvance(2);
    ɵɵtextInterpolate1("Page index: ", ctx_r277.pageEvent.pageIndex, "");
} }
/**
