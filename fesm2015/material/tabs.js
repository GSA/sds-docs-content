...
function TabGroupAsyncExample_mat_tab_3_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const tab_r76 = ɵɵnextContext().$implicit;
    ɵɵtextInterpolate(tab_r76.label);
} }
function TabGroupAsyncExample_mat_tab_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(2);
    ɵɵtextInterpolate1(" ", tab_r76.content, " ");
} }
/**
 * @record
 */
...
function TabGroupDynamicExample_mat_tab_12_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("click", function TabGroupDynamicExample_mat_tab_12_Template_button_click_2_listener($event) { ɵɵrestoreView(_r87); const index_r85 = ctx.index; const ctx_r86 = ɵɵnextContext(); return ctx_r86.removeTab(index_r85); });
    ɵɵtext(3, " Delete Tab ");
    ɵɵelementEnd();
    ɵɵelementEnd();
} if (rf & 2) {
    ...
    ɵɵproperty("label", tab_r84);
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" Contents for ", tab_r84, " tab ");
    ɵɵadvance(1);
    ɵɵproperty("disabled", ctx_r83.tabs.length === 1);
} }
/**
...
/** @nocollapse */ TabGroupDynamicExample.ɵcmp = ɵɵdefineComponent({ type: TabGroupDynamicExample, selectors: [["tab-group-dynamic-example"]], decls: 13, vars: 3, consts: [[1, "example-input-label"], ["matInput", "", "type", "number", 3, "formControl"], ["mat-raised-button", "", 1, "example-add-tab-button", 3, "click"], ["selectAfterAdding", ""], [3, "selectedIndex", "selectedIndexChange"], [3, "label", 4, "ngFor", "ngForOf"], [3, "label"], ["mat-raised-button", "", 1, "example-delete-tab-button", 3, "disabled", "click"]], template: function TabGroupDynamicExample_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵɵlistener("click", function TabGroupDynamicExample_Template_button_click_6_listener($event) { ɵɵrestoreView(_r88); const _r82 = ɵɵreference(9); return ctx.addTab(_r82.checked); });
...
function TabGroupLazyLoadedExample_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵtextInterpolate1(" Content 1 - Loaded: ", ɵɵpipeBind2(1, 1, ctx_r89.getTimeLoaded(1), "medium"), " ");
} }
function TabGroupLazyLoadedExample_ng_template_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵtextInterpolate1(" Content 2 - Loaded: ", ɵɵpipeBind2(1, 1, ctx_r90.getTimeLoaded(2), "medium"), " ");
} }
function TabGroupLazyLoadedExample_ng_template_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵtextInterpolate1(" Content 3 - Loaded: ", ɵɵpipeBind2(1, 1, ctx_r91.getTimeLoaded(3), "medium"), " ");
} }
/**
...
/** @nocollapse */ TabGroupThemeExample.ɵcmp = ɵɵdefineComponent({ type: TabGroupThemeExample, selectors: [["tab-group-theme-example"]], decls: 25, vars: 2, consts: [["value", "primary", "aria-label", "Change color"], ["colorToggle", "matButtonToggleGroup"], ["value", "primary"], ["value", "accent"], [1, "example-button-toggle-label"], ["backgroundColorToggle", "matButtonToggleGroup"], [3, "color", "backgroundColor"], ["label", "First"], ["label", "Second"], ["label", "Third"]], template: function TabGroupThemeExample_Template(rf, ctx) { if (rf & 1) {
        ...
        const _r92 = ɵɵreference(2);
        const _r93 = ɵɵreference(11);
        ɵɵadvance(18);
        ɵɵproperty("color", _r92.value)("backgroundColor", _r93.value);
...
function TabNavBarBasicExample_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("click", function TabNavBarBasicExample_a_1_Template_a_click_0_listener($event) { ɵɵrestoreView(_r97); const link_r95 = ctx.$implicit; const ctx_r96 = ɵɵnextContext(); return ctx_r96.activeLink = link_r95; });
    ɵɵtext(1);
    ɵɵelementEnd();
} if (rf & 2) {
    const link_r95 = ctx.$implicit;
    const ctx_r94 = ɵɵnextContext();
    ɵɵproperty("active", ctx_r94.activeLink == link_r95);
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" ", link_r95, " ");
} }
/**
