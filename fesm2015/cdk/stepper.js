...
function CustomStepper_button_9_Template(rf, ctx) { if (rf & 1) {
    const _r615 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "button", 6);
    ɵɵlistener("click", function CustomStepper_button_9_Template_button_click_0_listener($event) { ɵɵrestoreView(_r615); const i_r613 = ctx.index; const ctx_r614 = ɵɵnextContext(); return ctx_r614.onClick(i_r613); });
    ɵɵtext(1);
    ɵɵelementEnd();
} if (rf & 2) {
    const i_r613 = ctx.index;
    const ctx_r611 = ɵɵnextContext();
    ɵɵproperty("ngClass", ɵɵpureFunction1(2, _c0, ctx_r611.selectedIndex === i_r613));
    ɵɵadvance(1);
    ɵɵtextInterpolate1(" Step ", i_r613 + 1, " ");
} }
/**
