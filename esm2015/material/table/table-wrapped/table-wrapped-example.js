...
function TableWrappedExample_td_4_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate1(" ", element_r397.name, " ");
} }
...
function WrapperTable_td_4_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate1(" ", element_r405.position, " ");
} }
...
function WrapperTable_td_7_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate1(" ", element_r406.weight, " ");
} }
...
function WrapperTable_td_10_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(1);
    i0.ɵɵtextInterpolate1(" ", element_r407.symbol, " ");
} }
const _c1 = ["*"];
/**
 * @record
